window.addEventListener("load", function () {
    ...
    signup_form.addEventListener("submit", function (event) {
        ...
        // Set up request
        XHR.open("POST", "api/signin_submit.php");
    ...
    // add code to forgot_password form of assignment

   //add code corresponding to login form as a part of our assignment
...
// add function corresponding to forgot_password success
var forgot_password_success = function (event) {
    document.getElementById("loading").style.display = 'none';
