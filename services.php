...
<head>
 ...
 <!---- <link rel="stylesheet" href="https://stackpath.bootstrapcdn.com/bootstrap/4.3.1/css/bootstrap.min.css"
  ...
  <title>Services Provided By Raman Stationary</title>
</head>
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      <ul class="navbar-nav mr-auto">
        ...
        <li class="nav-item dropdown">
          <a class="nav-link dropdown-toggle active" href="services.php" id="navbarDropdown" role="button" data-toggle="dropdown"
    ...
    <div id="carouselExampleControls" class="carousel slide" data-bs-ride="carousel">
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img src="home3.jpg" class="d-block w-100" alt="home3.jpg">
        </div>
        <div class="carousel-item">
          <img src="home2.jpg" class="d-block w-100" alt="home2.jpg">
        </div>
        <div class="carousel-item">
          <img src="home1.jpg" class="d-block w-100" alt="home1.jpg">
        </div>
      </div>
...
<section class="text-gray-600 body-font">
  <div class="container px-5 py-24 mx-auto flex items-center md:flex-row flex-col">
    <div class="flex flex-col md:pr-10 md:mb-0 mb-6 pr-0 w-full md:w-auto md:text-left text-center">
      <h2 class="text-xs text-indigo-500 tracking-widest font-medium title-font mb-1">Raman Dictionary</h2>
